    ...
    <div class="drawer-body">
      ...
      <div class="right-panel">
        ...
        <div class="socials-col">
          ...
          <a href="https://discord.gg/gUgVq68vdx" class="social-link" target="_blank" rel="noopener">
            <div class="soc-icon">
...
const colAData = {
  ...
  items: [
    ...
    { slug: "EvoChains",     label: "EVO CHAINS",       enabled: true  },
    { slug: "LiveCards",     label: "UPGRADE HUB",     enabled: false  },
    { slug: "LTMCards",      label: "LTM CARD",        enabled: false  },
    { slug: "Rarity-Groups", label: "RARITY / GROUP",  enabled: false  },
    { slug: "Nation",        label: "NATION",          enabled: false  },
    { slug: "League",        label: "LEAGUE",          enabled: false  },
    { slug: "Club",          label: "CLUB",            enabled: false  },
  ]
};
...
const colBData = {
  ...
  items: [
    ...
    { slug: "Evolution",         label: "EVOLUTION",           enabled: false  },
    { slug: "Draft",             label: "DRAFT",               enabled: false  },
    { slug: "Ranked",            label: "RANKED",              enabled: false  },
    { slug: "Votes",              label: "VOTES",              enabled: true  },
    { slug: "Promotions",             label: "PROMOS",         enabled: true  },
...
const colCData = {
  items: [
    { slug: "Fmyclub",           label: "FATAL MY CLUB",       enabled: false  },
    { slug: "Fsim",              label: "FATAL SIM",           enabled: false  },
    { slug: "Fdraft",            label: "FATAL DRAFT",         enabled: false  },
    ...
    { slug: "Codes",             label: "CODES",               enabled: false  },
  ]
};
...
const colMiscData = [
  ...
  { label: "PREDICTOR (BUGGED)",  href: "/26/Predictor.html", enabled: true },
  { label: "38-0 (BUGGED)",  href: "/26/38-0.html", enabled: true },
];

const colDataData = [
  { label: "HOME PAGE",   href: "/index.html",   enabled: true  },
  { label: "ARTICLES",    href: "/news.html",    enabled: false  },
  { label: "CONTACT US",  href: "/contact.html", enabled: false  },
];
